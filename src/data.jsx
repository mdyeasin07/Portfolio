...
export const personalInfo = [
...

  {
    id: 9,
    title: 'LinkedIn : ',
    description: 'md-yeasin-5494a9231',
  },
...
export const resume = [
  {
    ...
    desc: 'Developed multiple WordPress projects, utilizing WordPress development best practices and adhering to project timelines. Resolved plugin bugs in a previous WordPress project, improving overall functionality and user experience.',
  },
...
export const portfolio = [
  {
    id: 1,
    img: Work1,
    title: 'Mutlivendor Ecommerce Website',
    details: [
      {
        icon: <FiFileText />,
        title: 'Project: ',
